...
class RedeamApiClientForUnitedParks
{
    /**
    ...
    public function getHeaders(array $headers = []): array
    {
        return array_merge(
            [
                'X-API-Key' => config('redeam.united_parks.api_key'),
                'X-API-Secret' => config('redeam.united_parks.api_secret'),
            ],
            $headers
        );
    }
    ...
    {
        return config('redeam.united_parks.host');
    }

    public function getVersion(): string
    {
        return config('redeam.united_parks.version');
    }
